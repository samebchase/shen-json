...
(compile <object> (explode (compile <lex-json-string> (explode (read-file-as-string "../test-data/trivial-object.json")))))
(compile <object> (explode (compile <lex-json-string> (explode (read-file-as-string "../test-data/object-newlines.json")))))
